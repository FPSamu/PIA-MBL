...
export default function App() {
  ...
  if (checkingSession) {
    ...
    content = (
      <GetStarted
        onGetStarted={navigateToFeatures}
    ...
    content = (
      <LoginScreen
        ...
        onSwitchToSignup={navigateToFeatures}
      />
    );
    ...
    content = (
      <SignupScreen
        ...
        onVerificationRequired={navigateToSplash}
        onboardingData={{
          selectedFeature,
          selectedGoal,
          customGoal,
