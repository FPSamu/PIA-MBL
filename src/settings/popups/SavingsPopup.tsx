...
interface SavingsPopupProps {
    ...
    onSavingsUpdated: (newSavings: number, newTitle: string) => void;
}
...
export default function SavingsPopup({
    ...
    useEffect(() => {
    if (visible) {
        setNewSavingsAmount(currentSavings ? currentSavings.toString() : "");
        setNewAccountTitle(currentTitle || "");
    }
}, [visible, currentSavings, currentTitle]);

    const handleUpdateSavings = async () => {
        const savingsValue = parseFloat(newSavingsAmount);
            ...
            >
                <View style={styles.popup}>
                    ...
                    <View style={styles.content}>
                        ...
                        <Text style={styles.subtitle}>Update your savings account information</Text>

                        {(currentSavings !== null || currentTitle) && (
                        ...
                        {/* Amount Input */}
                        <View style={styles.inputSection}>
                            <Text style={styles.inputLabel}>Savings Amount</Text>
                            <View style={styles.inputContainer}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={(text) =>
                                        setNewSavingsAmount(formatCurrency(text))
                                    }
                                    placeholder="0.00"
                        ...
                        {/* Preview */}
                        {(newSavingsAmount && !isNaN(parseFloat(newSavingsAmount))) || newAccountTitle.trim() ? (
                            <View style={styles.previewContainer}>
                                ...
                                {newSavingsAmount && !isNaN(parseFloat(newSavingsAmount)) && (
                                    <View style={styles.previewRow}>
                                        <Text style={styles.previewFieldLabel}>Amount:</Text>
                                        <Text style={styles.previewAmount}>
                                            ${parseFloat(newSavingsAmount).toLocaleString()}
                                        </Text>
                                    </View>
                                )}
                            </View>
